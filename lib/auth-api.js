...
class AuthApi {
    constructor() { }
    init(config, db, onUserDelete = async (user) => null, router = express_1.Router()) {
        ...
        authRouter.use(middleware_1.handleError('auth'));
        ...
        router.use(middleware_1.handleError('api'));
    }
}
